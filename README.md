...
## Sample: Step-by-Step Guide to detect milk bottles in images
...
1. [Generalized Fine-tuning](./step1-generalized-fine-tuning.md)
1. [Reinforcement Learning with Human Feedback](./step2-reinforcement-learning.md)
